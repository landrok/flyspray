			...
			<form action="index.php" method="post" name="database_form">
				<?php echo $message; ?>
				<h1><?php echo Filters::noXSS(L('administration_setup')); ?></h1>
				<h2><?php echo Filters::noXSS(L('setup_application_value')); ?></h2>
	...
	if(document.getElementById(id).type=="text") {
		...
		document.getElementById(id).type="text";
				...
				<table class="formBlock" style="width:68%;">
					...
					<tr>
						<td><?php echo Filters::noXSS(L('syntax_text')); ?></td>
						<td>
					...
					<?php if ($daemonise): ?>
					<tr>
						<td align="right" title="<?php echo Filters::noXSS(L('schedule_title')); ?>"><?php echo Filters::noXSS(L('enable_scheduling')); ?></td>
						<td align="center"><?php echo $daemonise; ?></td>
					</tr>
					<?php endif; ?>
				</table>
				<p><?php echo Filters::noXSS(L('admin_setup_tip1')); ?></p>
				<p><?php echo Filters::noXSS(L('admin_setup_tip2')); ?></p>
				<p><?php echo Filters::noXSS(L('admin_setup_tip3')); ?></p>
				...
				<p><?php echo Filters::noXSS(L('proceedtofinalsetuptext')); ?>
				</p>
				</div>
			</form>
			</div><!-- end of right -->
